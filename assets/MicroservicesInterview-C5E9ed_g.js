import{c as e,d as t,t as n,u as r}from"./index-BfVCDDJ-.js";var i=t(r(),1),a=n(),o=e=>e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#x27;`),s=(e=>{let t=[],n=e.split(`
...
60. **Design a Production-Ready Banking Payment System using Spring Boot Microservices.**
    ...
    - **Interview Tip**: Explain requirements, microservices, database strategy, communication, security, resilience, scalability, monitoring, deployment, and production best practices.`),c=s.reduce((e,t)=>e+t.questions.length,0);function l(){let[t,n]=(0,i.useState)(null),r=e=>{n(t===e?null:e)};return(0,a.jsxs)(`div`,{className:`interview-page`,children:[(0,a.jsx)(`section`,{className:`interview-header`,children:(0,a.jsxs)(`div`,{className:`interview-header-content`,children:[(0,a.jsx)(e,{to:`/microservices`,className:`back-button`,children:`← Back to Microservices`}),(0,a.jsx)(`h1`,{className:`interview-title`,children:`Microservices Interview Questions`}),(0,a.jsx)(`p`,{className:`interview-subtitle`,children:`Master Microservices interview questions with detailed answers and code examples`}),(0,a.jsxs)(`div`,{className:`interview-stats`,children:[(0,a.jsxs)(`div`,{className:`interview-stat`,children:[(0,a.jsxs)(`span`,{className:`stat-number`,children:[c,`+`]}),(0,a.jsx)(`span`,{className:`stat-label`,children:`Questions`})]}),(0,a.jsxs)(`div`,{className:`interview-stat`,children:[(0,a.jsx)(`span`,{className:`stat-number`,children:s.length}),(0,a.jsx)(`span`,{className:`stat-label`,children:`Categories`})]}),(0,a.jsxs)(`div`,{className:`interview-stat`,children:[(0,a.jsx)(`span`,{className:`stat-number`,children:`100%`}),(0,a.jsx)(`span`,{className:`stat-label`,children:`Free`})]})]})]})}),(0,a.jsx)(`section`,{className:`questions-section`,children:(0,a.jsx)(`div`,{className:`questions-container`,children:(0,a.jsx)(`div`,{className:`questions-list`,children:s.map((e,n)=>(0,a.jsxs)(`div`,{className:`category-section`,children:[(0,a.jsx)(`h2`,{className:`category-title`,children:e.name}),(0,a.jsx)(`div`,{className:`questions-vertical`,children:e.questions.map(e=>(0,a.jsxs)(`div`,{className:`question-item-vertical ${t===e.id?`active`:``}`,children:[(0,a.jsxs)(`div`,{className:`question-item-header`,onClick:()=>r(e.id),children:[(0,a.jsxs)(`span`,{className:`q-number`,children:[`Q`,e.id]}),(0,a.jsx)(`p`,{className:`q-text`,children:e.question}),(0,a.jsx)(`span`,{className:`expand-arrow ${t===e.id?`expanded`:``}`,children:`▼`})]}),t===e.id&&(0,a.jsx)(`div`,{className:`question-item-content`,children:(0,a.jsx)(`div`,{className:`question-card`,children:(0,a.jsxs)(`div`,{className:`question-answer`,children:[(0,a.jsx)(`h3`,{className:`answer-title`,children:`Answer:`}),e.response.map((e,t)=>e.type===`code`?(0,a.jsxs)(`div`,{className:`code-block`,children:[(0,a.jsx)(`div`,{className:`code-header`,children:(0,a.jsx)(`span`,{className:`code-language`,children:e.language||`java`})}),(0,a.jsx)(`pre`,{className:`language-${e.language||`java`}`,children:(0,a.jsx)(`code`,{className:`language-${e.language||`java`}`,dangerouslySetInnerHTML:{__html:o(e.content,e.language)}})})]},t):(0,a.jsx)(`p`,{className:`answer-text`,children:e.content},t))]})})})]},e.id))})]},n))})})})]})}export{l as default};