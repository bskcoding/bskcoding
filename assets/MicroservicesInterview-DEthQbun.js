import{n as e}from"./rolldown-runtime-Bh1tDfsg.js";import{c as t,d as n,t as r,u as i}from"./index-DloYHhOi.js";import{t as a}from"./prism-tomorrow-BCrLxzm9.js";var o=e(n(),1),s=i();a();var c=r();typeof window<`u`&&window.Prism;var l=`## Microservices Interview Questions
...
60. **Design a Production-Ready Banking Payment System using Spring Boot Microservices.**
    ...
    - **Interview Tip**: Explain requirements, microservices, database strategy, communication, security, resilience, scalability, monitoring, deployment, and production best practices.`,u=(e,t)=>{let n=t||`java`;try{if(typeof window>`u`||!window.Prism||!window.Prism.languages)return e;let t=window.Prism.languages[n]||window.Prism.languages.java;return t&&window.Prism.highlight(e,t,n)||e}catch(n){return console.warn(`Prism highlighting failed for language '${t}':`,n),e}},d=(e=>{let t=[],n=e.split(`
...
`).trim();i.response.push({type:`code`,content:n,language:s})}o=[]}continue}if(a){o.push(c);continue}let u=c.match(/^###\s+(.+)/);if(u){r={name:u[1],questions:[]},t.push(r),i=null;continue}let d=c.match(/^(\d+)\.\s*\*\*(.+?)\*\*/);if(d)i={id:d[1],question:d[2],response:[]},r&&r.questions.push(i);else if(i&&c.trim().startsWith(`- **Response**:`)){let e=c.replace(`- **Response**:`,``).trim();e&&i.response.push({type:`text`,content:e})}else if(i&&c.trim()&&!c.trim().startsWith(`#`)){let e=c.trim();if(e&&e.length>1&&!e.match(/^[-*]\s*$/)&&!e.match(/^[a-zA-Z]$/)&&!e.match(/^[0-9]$/)){let t=e.replace(/^\s*[-*]\s+/,``).replace(/\*\*(.+?)\*\*/g,`$1`).replace(/`([^`]+)`/g,`$1`);i.response.push({type:`text`,content:t})}}}return t})(l),f=d.reduce((e,t)=>e+t.questions.length,0);function p(){let e=(0,s.c)(13),[n,r]=(0,o.useState)(null),i;e[0]===n?i=e[1]:(i=e=>{r(n===e?null:e)},e[0]=n,e[1]=i);let a=i,l,u,p;e[2]===Symbol.for(`react.memo_cache_sentinel`)?(l=(0,c.jsx)(t,{to:`/microservices`,className:`back-button`,children:`← Back to Microservices`}),u=(0,c.jsx)(`h1`,{className:`interview-title`,children:`Microservices Interview Questions`}),p=(0,c.jsx)(`p`,{className:`interview-subtitle`,children:`Master Microservices interview questions with detailed answers and code examples`}),e[2]=l,e[3]=u,e[4]=p):(l=e[2],u=e[3],p=e[4]);let h;e[5]===Symbol.for(`react.memo_cache_sentinel`)?(h=(0,c.jsxs)(`div`,{className:`interview-stat`,children:[(0,c.jsxs)(`span`,{className:`stat-number`,children:[f,`+`]}),(0,c.jsx)(`span`,{className:`stat-label`,children:`Questions`})]}),e[5]=h):h=e[5];let g;e[6]===Symbol.for(`react.memo_cache_sentinel`)?(g=(0,c.jsxs)(`div`,{className:`interview-stat`,children:[(0,c.jsx)(`span`,{className:`stat-number`,children:d.length}),(0,c.jsx)(`span`,{className:`stat-label`,children:`Categories`})]}),e[6]=g):g=e[6];let _;e[7]===Symbol.for(`react.memo_cache_sentinel`)?(_=(0,c.jsx)(`section`,{className:`interview-header`,children:(0,c.jsxs)(`div`,{className:`interview-header-content`,children:[l,u,p,(0,c.jsxs)(`div`,{className:`interview-stats`,children:[h,g,(0,c.jsxs)(`div`,{className:`interview-stat`,children:[(0,c.jsx)(`span`,{className:`stat-number`,children:`100%`}),(0,c.jsx)(`span`,{className:`stat-label`,children:`Free`})]})]})]})}),e[7]=_):_=e[7];let v;e[8]!==n||e[9]!==a?(v=d.map((e,t)=>(0,c.jsxs)(`div`,{className:`category-section`,children:[(0,c.jsx)(`h2`,{className:`category-title`,children:e.name}),(0,c.jsx)(`div`,{className:`questions-vertical`,children:e.questions.map(e=>(0,c.jsxs)(`div`,{className:`question-item-vertical ${n===e.id?`active`:``}`,children:[(0,c.jsxs)(`div`,{className:`question-item-header`,onClick:()=>a(e.id),children:[(0,c.jsxs)(`span`,{className:`q-number`,children:[`Q`,e.id]}),(0,c.jsx)(`p`,{className:`q-text`,children:e.question}),(0,c.jsx)(`span`,{className:`expand-arrow ${n===e.id?`expanded`:``}`,children:`▼`})]}),n===e.id&&(0,c.jsx)(`div`,{className:`question-item-content`,children:(0,c.jsx)(`div`,{className:`question-card`,children:(0,c.jsxs)(`div`,{className:`question-answer`,children:[(0,c.jsx)(`h3`,{className:`answer-title`,children:`Answer:`}),e.response.map(m)]})})})]},e.id))})]},t)),e[8]=n,e[9]=a,e[10]=v):v=e[10];let y;return e[11]===v?y=e[12]:(y=(0,c.jsxs)(`div`,{className:`interview-page`,children:[_,(0,c.jsx)(`section`,{className:`questions-section`,children:(0,c.jsx)(`div`,{className:`questions-container`,children:(0,c.jsx)(`div`,{className:`questions-list`,children:v})})})]}),e[11]=v,e[12]=y),y}function m(e,t){return e.type===`code`?(0,c.jsxs)(`div`,{className:`code-block`,children:[(0,c.jsx)(`div`,{className:`code-header`,children:(0,c.jsx)(`span`,{className:`code-language`,children:e.language||`java`})}),(0,c.jsx)(`pre`,{className:`language-${e.language||`java`}`,children:(0,c.jsx)(`code`,{className:`language-${e.language||`java`}`,dangerouslySetInnerHTML:{__html:u(e.content,e.language)}})})]},t):(0,c.jsx)(`p`,{className:`answer-text`,children:e.content},t)}export{p as default};