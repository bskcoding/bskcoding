import{c as e,d as t,t as n,u as r}from"./index-BfVCDDJ-.js";var i=t(r(),1),a=`## Spring Boot Interview Questions
...
100. **What are the new features introduced in the latest versions of Spring Boot?**
    ...
    - **Example**:
      ...
      \`\`\`
    - **Note**: Check the Spring Boot release notes for details.`,s=n(),c=a+o,l=e=>e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#x27;`),u=(e=>{let t=[],n=e.split(`
...
`).trim();i.response.push({type:`code`,content:n,language:s})}o=[]}continue}if(a){o.push(c);continue}let u=c.match(/^###\s+(.+)/);if(u){r={name:u[1],questions:[]},t.push(r),i=null;continue}let d=c.match(/^(\d+)\.\s*\*\*(.+?)\*\*/);if(d)i={id:d[1],question:d[2],response:[]},r&&r.questions.push(i);else if(i&&c.trim().startsWith(`- **Answer**:`)){let e=c.replace(`- **Answer**:`,``).trim();e&&i.response.push({type:`text`,content:e})}else if(i&&c.trim().startsWith(`- **Example**:`)){let e=c.replace(`- **Example**:`,``).trim();e&&i.response.push({type:`example`,content:e})}else if(i&&c.trim().startsWith(`- **Note**:`)){let e=c.replace(`- **Note**:`,``).trim();e&&i.response.push({type:`note`,content:e})}else if(i&&c.trim()&&!c.trim().startsWith(`#`)){let e=c.trim();if(e&&e.length>1&&!e.match(/^[-*]\s*$/)&&!e.match(/^[a-zA-Z]$/)&&!e.match(/^[0-9]$/)){let t=e.replace(/^\s*[-*]\s+/,``).replace(/\*\*(.+?)\*\*/g,`$1`).replace(/`([^`]+)`/g,`$1`);i.response.push({type:`text`,content:t})}}}return t})(c),d=u.reduce((e,t)=>e+t.questions.length,0);function f(){let[t,n]=(0,i.useState)(null),r=e=>{n(t===e?null:e)};return(0,s.jsxs)(`div`,{className:`spring-boot-interview-page`,children:[(0,s.jsx)(`section`,{className:`interview-header`,children:(0,s.jsxs)(`div`,{className:`interview-header-content`,children:[(0,s.jsx)(e,{to:`/spring-boot`,className:`back-button`,children:`← Back to Spring Boot`}),(0,s.jsx)(`h1`,{className:`interview-title`,children:`Spring Boot Interview Questions`}),(0,s.jsx)(`p`,{className:`interview-subtitle`,children:`Master Spring Boot interview questions with detailed answers and code examples`}),(0,s.jsxs)(`div`,{className:`interview-stats`,children:[(0,s.jsxs)(`div`,{className:`interview-stat`,children:[(0,s.jsxs)(`span`,{className:`stat-number`,children:[d,`+`]}),(0,s.jsx)(`span`,{className:`stat-label`,children:`Questions`})]}),(0,s.jsxs)(`div`,{className:`interview-stat`,children:[(0,s.jsx)(`span`,{className:`stat-number`,children:u.length}),(0,s.jsx)(`span`,{className:`stat-label`,children:`Categories`})]}),(0,s.jsxs)(`div`,{className:`interview-stat`,children:[(0,s.jsx)(`span`,{className:`stat-number`,children:`100%`}),(0,s.jsx)(`span`,{className:`stat-label`,children:`Free`})]})]})]})}),(0,s.jsx)(`section`,{className:`questions-section`,children:(0,s.jsx)(`div`,{className:`questions-container`,children:(0,s.jsx)(`div`,{className:`questions-list`,children:u.map((e,n)=>(0,s.jsxs)(`div`,{className:`category-section`,children:[(0,s.jsx)(`h2`,{className:`category-title`,children:e.name}),(0,s.jsx)(`div`,{className:`questions-vertical`,children:e.questions.map(e=>(0,s.jsxs)(`div`,{className:`question-item-vertical ${t===e.id?`active`:``}`,children:[(0,s.jsxs)(`div`,{className:`question-item-header`,onClick:()=>r(e.id),children:[(0,s.jsxs)(`span`,{className:`q-number`,children:[`Q`,e.id]}),(0,s.jsx)(`p`,{className:`q-text`,children:e.question}),(0,s.jsx)(`span`,{className:`expand-arrow ${t===e.id?`expanded`:``}`,children:`▼`})]}),t===e.id&&(0,s.jsx)(`div`,{className:`question-item-content`,children:(0,s.jsx)(`div`,{className:`question-card`,children:(0,s.jsxs)(`div`,{className:`question-answer`,children:[(0,s.jsx)(`h3`,{className:`answer-title`,children:`Answer:`}),e.response.map((e,t)=>e.type===`code`?(0,s.jsxs)(`div`,{className:`code-block`,children:[(0,s.jsx)(`div`,{className:`code-header`,children:(0,s.jsx)(`span`,{className:`code-language`,children:e.language||`java`})}),(0,s.jsx)(`pre`,{className:`language-${e.language||`java`}`,children:(0,s.jsx)(`code`,{className:`language-${e.language||`java`}`,dangerouslySetInnerHTML:{__html:l(e.content,e.language)}})})]},t):e.type===`example`?(0,s.jsxs)(`p`,{className:`answer-text`,children:[`📘 `,e.content]},t):e.type===`note`?(0,s.jsxs)(`p`,{className:`answer-text`,children:[`💡 `,e.content]},t):(0,s.jsx)(`p`,{className:`answer-text`,children:e.content},t))]})})})]},e.id))})]},n))})})})]})}export{f as default};