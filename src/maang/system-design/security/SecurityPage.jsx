  ...
  return (
    ...
    >
      ...
      <div className="acid-card-actions">
        ...
        <span className="acid-card-badge">Security</span>
      </div>
    ...
    <div className="acid-page">
      ...
      <section className="acid-hero">
        ...
        <h1 className="acid-title">
          🔐 Security <span>Fundamentals</span>
        </h1>
        ...
        <div className="acid-chip-row">
          ...
          <span className="acid-chip">🎫 OAuth2 &amp; JWT</span>
          <span className="acid-chip">🔒 Encryption everywhere</span>
        </div>
      </section>

      {/* ===== TOPIC CARDS ===== */}
      <section className="acid-props">
        <h2 className="acid-section-title">The 5 Security Concepts</h2>
