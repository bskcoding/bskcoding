...
import "./JavaScriptTopics.css";

function JavaScriptTopics() {
  const jsColor = "#f7df1e";

  return (
    <div className="js-topics-page">
      {/* Hero Section */}
      <section className="header-section">
        <div className="logo-container">
          <span className="logo-icon">🟡</span>
          <h1 className="logo-text">JAVASCRIPT</h1>
        </div>
        <p className="subtitle">
          Master JavaScript with comprehensive courses and interview preparation
        </p>
      </section>
      ...
      <section className="skills-section">
        ...
        <div className="skills-grid">
            ...
            <div className="skill-card" style={{ borderColor: jsColor }}>
              <div className="skill-card-top">
                <span
                  ...
                  style={{
                    backgroundColor: jsColor + "18",
                    color: jsColor,
                    boxShadow: `0 0 20px ${jsColor}25, inset 0 0 0 1px ${jsColor}30`,
                  }}
                >
                  📚
                </span>
                <span className="skill-card-title">JavaScript Full Course</span>
              </div>
              <div className="skill-card-middle">
                ...
                <span
                  ...
                  style={{
                    background: jsColor + "18",
                    color: jsColor,
                    borderColor: jsColor + "40",
                  }}
                >
                  Course
                </span>
              ...
              <div className="skill-card-bottom">
                ...
                <button
                  ...
                  style={{
                    background: jsColor + "15",
                    color: jsColor,
                    borderColor: jsColor + "35",
                  }}
                >
                  Start Learning
                  <svg
          ...
          <Link to="/javascript/interview" className="skill-card-link">
            <div className="skill-card" style={{ borderColor: jsColor }}>
              <div className="skill-card-top">
                <span
                  className="skill-card-icon"
